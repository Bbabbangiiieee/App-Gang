                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                    ...
                                    <div class="form-group col-md-12" style="margin-left:50px;">
                                        ...
                                        <div class="col-md-6 form-check">
                                            <input type="checkbox" class="pl-3" id="exampleCheck1" style="margin-left:50px;">
                                   ...
                                   <div class="form-group col-md-12" style="margin-left: 137px; font-size: 15px;">Create an Account?  <a href="register.php" class="text-right f-w-500 text-gray">Register</a></label></div>
