...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2022 at 03:21 AM
...
(102, 'Cotrimoxazole', 'Septrin', 'Antibiotic', 25, '50.00'),
(118, 'Mefenamic', 'Ponstan', 'Tablet', 10, '12.00');
...
--
ALTER TABLE `medicine`
  MODIFY `med_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
