                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="ontrol-label">Medicine Name</label>
                                                  <input type="text" class="form-control" id="med_name" placeholder="Medicine Name" name="med_name" autocomplete="off" required="" pattern="^[0-9]+$"/>
                                                </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Price</label>
                                                  <input type="text" class="form-control" id="med_price" placeholder="Price" name="med_price" autocomplete="off"  required="" pattern="^[0-9]+$"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Packaging</label>
                                                  <input type="text" class="form-control" id="med_pack" placeholder="Packaging" name="med_pack" autocomplete="off"  required="" pattern="^[0-9]+$"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Dosage</label>
                                                  <input type="text" class="form-control" id="med_dosage" placeholder="Dosage" name="med_dosage" autocomplete="off"  required="" pattern="^[0-9]+$"/>
                                        </div>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                        ...
                        ?>
                                        ...
                                        <div class="form-group col-md-6">
                                                <label class="control-label">Status</label>
                                                     <select class="form-control" id="med_stat" name="med_stat">
                        <option value="">SELECT</option>
